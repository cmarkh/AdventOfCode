...
mod tests {
    ...
    #[test]
    fn test_part1() {
        let case = std::fs::read_to_string("src/input1.txt").unwrap();
        let ans = part1(&case);
        println!("{}", ans);
        assert_eq!(ans, 56049);
    }
    ...
    #[test]
    fn ex1() {
        let case = std::fs::read_to_string("src/ex1.txt").unwrap();
    ...
    #[test]
    fn ex2() {
        let case = std::fs::read_to_string("src/ex2.txt").unwrap();
        let ans = part2(&case);
        assert_eq!(ans, 281);
    }
